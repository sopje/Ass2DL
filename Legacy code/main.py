...
#%%
print(train)
leave_one_out_test = train.groupby("userID").last().reset_index()
train = pd.merge(train, leave_one_out_test, indicator=True, how='outer').query('_merge=="left_only"').drop('_merge', axis=1)
print(train)
#%%
